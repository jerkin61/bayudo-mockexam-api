...
use Jerquin\Database\Models\ExamTaken;
use Jerquin\Database\Repositories\ExamTakenRepository;
use Jerquin\Http\Requests\ExamTakenCreateRequest;
use Jerquin\Http\Requests\ExamTakenUpdateRequest;
use Jerquin\Http\Requests\ProductUpdateRequest;
use Illuminate\Support\Facades\Response;
use Illuminate\Support\Facades\Validator;

class ExamTakenController extends CoreController
{
    public $repository;

    public function __construct(ExamTakenRepository $repository)
    {
    ...
    public function index(Request $request)
  {
    ...
    public function update(ExamTakenUpdateRequest $request, $id)
    {
        try {
    ...
    public function store(ExamTakenCreateRequest $request)
    {
